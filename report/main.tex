...
Figure \ref{fig:architecture} shows the complete end-to-end pipeline from data input to deployed prediction.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{system_architecture.png}
\caption{System Architecture: End-to-End Pipeline (Designed by Hardik)}
...
\begin{enumerate}
    \item \textbf{Data Layer}: Raw loan data (50K $\times$ 20 features)
    \item \textbf{Preprocessing Pipeline}: Feature selection (20 $\rightarrow$ 18), One-Hot Encoding (3 $\rightarrow$ 12), StandardScaler, Train/Test Split (80/20)
    \item \textbf{Model Training}: Logistic Regression (86.4\%) $\rightarrow$ Error Analysis $\rightarrow$ XGBoost (92.9\%)
    \item \textbf{Model Artifacts}: Saved \texttt{feature\_names.pkl}, \texttt{scaler.pkl}, \texttt{xgboost.pkl}
    \item \textbf{Production App}: Streamlit Web App with GitHub CI/CD to Streamlit Cloud
\end{enumerate}
